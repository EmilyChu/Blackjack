...
class TestDeck < Minitest::Test
  ...
  def test_tracking_draws
    deck = Deck.new
    drawn_card = deck.draw                  # 51 cards left after draw
    assert_equal deck.cards.count, 51       # @cards == 51 cards
    refute_includes deck.cards, drawn_card  # drawn-51 cards versus deck-52 cards
    assert_includes deck.drawn, drawn_card  # drawn-51 cards versus 1 card (that i popped out)
  end
end
